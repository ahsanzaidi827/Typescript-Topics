...
let courses:string[] = ["Generative AI" , "Metarverse" , "Blockchain" , "Web3.0"]
...
let fruits2:string[]  = ["Banana" , "Grapes" , "Watermelon"]
...
//                  0         1        2       3       4                    5
 ...
 let nestedarray:(string | number[] | boolean[])[] = ["ahsan" , "Ul haq" , [12 , 23, 45], [true , false]] 

let nestedarray2:(number | string[] | boolean[])[] = [4 , 47 ,["a"] , [true]]
 let nestedarray3:(string | string[])[] = ["AHSAN" , ["ahsan"]]
 ...
 let FavPlaces:string[] = ["Dubai" , "Maldive" , "Seoul" , "Baali" , "Azad Kashmir" , ]
 //                           0          1           2         3          4            
 ...
 let myFAVcar:string[] = ["COROLLA" , "VIGO" , "AUDI"  , "THUNDRA"];
