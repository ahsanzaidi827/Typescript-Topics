...
function welcome(venue:string , learning:string) {
...
function orderplace(from: string , to:string) {
...
function squareroot(digit:number) {
...
function accessories(mob:string = "iphone") {
